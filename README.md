...
<b>Version 2026.05.10 is the newest LTS release.</b><br>
<b>Version 2026.05.10 is the newest source release.</b>
...
<p>2025.12.25</p>
<ul>
<li>Final LTS release of 2025.</li>
<li>New Canvas Settings -> Display -> Show Structures Tree Widget.</li>
<li>New object visibility property.</li>
<li>New tool for setting widget visibility to true.</li>
</ul>

<p>2025.11.05</p>
<ul>
<li>Scroll views with keyboard arrow keys.</li>
</ul>
...
<ul>
<li>ASH: close.</li>
<li>Adjust the number of columns in the recent-diagrams-view on
  resize events.</li>
<li>Serial port windows are now children of the main window.</li>
<li>Show objects as quickly as possible after a diagram is
  opened.</li>
</ul>
...
<li>Added new color property in Port Colors.</li>
<li>Depict full input ports on objects.</li>
<li>Simplified color-selection item delegate.</li>
</ul>

<p>2025.05.05</p>
<ul>
<li>Another blue-balloon-papa release!</li>
<li>Optional tab bar. Please see Glitch Preferences and View.</li>
</ul>
...
<p>2025.03.15</p>
<ul>
<li>New Canvas Settings -> Project -> Board, Canvas Settings ->
  Project -> Communications Port.</li>
<li>New shortcut Ctrl + N: create new Arduino diagram.</li>
<li>Process double-click events in the recent-diagrams view.</li>
<li>Sort the Port Name combination box contents in the Serial Port
  Window before assigning the previously-connected value.</li>
</ul>
